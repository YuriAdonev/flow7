...
const MaterialTypesEditTableRow = (props) => {
  const tableActions = {
    title: 'Действия',
    itemsList: [
      {
  ...
  const childs = props.fieldTypes[props.index].children.map((item, index) => {
    ...
    return (
      ...
      >
        ...
        <td className="material-type-edit-table__characteristic table__col">
          <div className="flex">
        ...
        <td className="material-type-edit-table__required table__col">
          <label>
            <input
              type="checkbox"
        ...
        <td className="material-type-edit-table__value-type table__col">
          <TableSelect
        ...
        <td className="material-type-edit-table__default table__col">
        ...
        <td className="material-type-edit-table__units table__col table__col--last">
          <TableSelect
...
export default MaterialTypesEditTableRow;
