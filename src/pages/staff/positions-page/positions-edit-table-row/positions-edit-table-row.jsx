...
const PositionsEditTableRow = (props) => {
  const tableActions = {
    title: 'Действия',
    itemsList: [
      {
  ...
  const childs = props.fieldTypes[props.index].children.map((item, index) => {
    ...
    return (
      ...
      >
        ...
        <td className="positions-edit-table__label table__col">
          <div className="flex">
        ...
        <td className="positions-edit-table__required table__col">
          <label>
            <input
              type="checkbox"
        ...
        <td className="positions-edit-table__type table__col">
          <TableSelect
        ...
        <td className="positions-edit-table__default table__col table__col--last">
...
export default PositionsEditTableRow;
